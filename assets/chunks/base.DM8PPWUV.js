import{_ as s,o as a,c as r,j as n,d as o,p as e,a0 as l,n as u}from"./framework.danP1z9m.js";const m=`<template>\r
...
`,d={},p={class:"flex ctx-c-bg_gray ctx-c-txt_primary"};function v(b,t){return a(),r("div",p,t[0]||(t[0]=[n("div",{class:"px-2 c-ctx-c-txt-700 bg-ctx-c-bg-300"}," light ",-1),n("div",{class:"c-ctx-c-txt-700 bg-ctx-c-bg-300 px-2 ctx-r-y"}," dark ",-1)]))}const Z=s(d,[["render",v]]),g=`<script setup lang="ts">\r
