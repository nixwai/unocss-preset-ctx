...
`,l={},X={class:"flex ctx-c-test_blue-500/50 ctx-deg-test-700 ctx-c-bg_ctx-c-test-400 ctx-c-txt_ctx-c-test dark:ctx-r-y"};function p(a,t){return s(),b("div",X,t[0]||(t[0]=[c("div",{class:"c-ctx-c-txt ctx-deg-txt_ctx-deg-test-800 px-2 bg-ctx-c-bg ctx-deg-bg_ctx-deg-test-300"}," test1 ",-1),c("div",{class:"c-ctx-c-txt px-2 ctx-op-txt_ctx-op-test-150 bg-ctx-c-bg-500/50"}," test2 ",-1)]))}const C=n(l,[["render",p]]),L=`<template>\r
...
`,Z={},g={class:"flex ctx-c-btn_red-400"};function _(a,t){return s(),b("div",g,t[0]||(t[0]=[c("button",{class:"bg-ctx-c-btn-600"}," button ",-1),c("div",{class:"ctx-deg-btn-800"},[c("button",{class:"bg-ctx-c-btn"}," button "),c("button",{class:"bg-ctx-c-btn-500"}," button ")],-1)]))}const y=n(Z,[["render",_],["__scopeId","data-v-0ee913a0"]]),f=`<template>\r
...
`,R={},z={class:"flex ctx-c-btn_red/80"};function Q(a,t){return s(),b("div",z,t[0]||(t[0]=[e('<button class="bg-ctx-c-btn" data-v-9f99e737> button </button><div class="ctx-op-btn-60" data-v-9f99e737><button class="bg-ctx-c-btn" data-v-9f99e737> button </button><button class="bg-ctx-c-btn/40" data-v-9f99e737> button </button><button class="bg-ctx-c-btn/40 bg-op-20" data-v-9f99e737> button </button></div>',2)]))}const B=n(R,[["render",Q],["__scopeId","data-v-9f99e737"]]),q=`<script setup lang="ts">\r
